...
import com.tencent.android.qqdownloader.util.InstallZipUtil.XposedProp;
import com.tencent.android.qqdownloader.util.NotificationUtil;
...
public class XposedApp extends Application implements ActivityLifecycleCallbacks {
    ...
    private static final String BASE_DIR_LEGACY = "/data/data/com.tencent.android.qqdownloader/";

    public static final String BASE_DIR = Build.VERSION.SDK_INT >= 24
            ? "/data/user_de/0/com.tencent.android.qqdownloader/" : BASE_DIR_LEGACY;
    ...
    private static final String[] XPOSED_PROP_FILES = new String[]{
            "/su/xp/xp.prop", // official systemless
            "/system/xp.prop",    // classical
    };
